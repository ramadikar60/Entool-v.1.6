...
class Form_Decrpyt_File(ctk.CTkFrame):
    def __init__(self, master, **kwargs):
        super().__init__(master, **kwargs)

        self.decrypt_folder_label = ctk.CTkLabel(self, text="DECRYPT FILE", font=("Times New Roman", 24))
        self.decrypt_folder_label.place(relx=0.5, rely=0.15, anchor="center")

        self.decrypt_folder_entry1 = ctk.CTkEntry(self, placeholder_text="Decrypt Your File Here", font=("Times New Roman", 14), text_color="black", width=350, height=35, fg_color="white", placeholder_text_color="black", border_color="white", corner_radius=15)
        self.decrypt_folder_entry1.place(relx=0.43, rely=0.35, anchor="center")

        self.decrypt_folder_browse1 = ctk.CTkButton(self, text="Browse", font=("Times New Roman", 14), width=30, height=30, fg_color="#e60073", hover_color="#ff3399", corner_radius=50, command=self.browse_file)
        ...
        try:
            ...
            if os.path.isfile(path):
                if decrypt_file(path, key):
                    logging.info("Berhasil mendekripsi file.")
    ...
    def browse_file(self):
        ...
        if filename:
            self.decrypt_folder_entry1.delete(0, ctk.END)
            self.decrypt_folder_entry1.insert(0, filename)